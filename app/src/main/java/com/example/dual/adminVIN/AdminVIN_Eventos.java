...
import com.example.dual.adminCE.AdminCE_Eventos;
...
public class AdminVIN_Eventos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_vin_eventos2);
    ...
    private class GuardarEventoTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado) {
            ...
            Toast.makeText(AdminVIN_Eventos.this, "Evento agregado" + resultado, Toast.LENGTH_SHORT).show();
    ...
    private class EliminarEventoTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado) {
            if (resultado != null && !resultado.isEmpty()) {
                // Muestra el resultado en un mensaje Toast
                Toast.makeText(AdminVIN_Eventos.this, "Resultado: " + resultado, Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(AdminVIN_Eventos.this, "No se recibió respuesta del servidor", Toast.LENGTH_SHORT).show();
            }
        }
    }
}