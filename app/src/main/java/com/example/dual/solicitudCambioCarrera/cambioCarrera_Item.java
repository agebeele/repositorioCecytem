...
public class cambioCarrera_Item extends AppCompatActivity {
    TextView fecha, matricula, nombre, paterno, materno, grupo, carreraActual, carreraCambio, motivos, promedio, correo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correo =(TextView) findViewById(R.id.item_correoCambio);
